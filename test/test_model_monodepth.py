...
class conv(nn.Module):
    ...
    def __init__(self, num_in_layers, num_out_layers, kernel_size, stride):
        ...
        self.conv_base = nn.Conv2d(num_in_layers,
                                   num_out_layers,
...
class resconv(nn.Module):
    ...
    def __init__(self, num_in_layers, num_out_layers, stride):
        ...
        self.conv3 = nn.Conv2d(num_out_layers,
                               4 * num_out_layers,
                               kernel_size=1,
                               stride=1)
        self.conv4 = nn.Conv2d(num_in_layers,
                               4 * num_out_layers,
                               kernel_size=1,
                               stride=stride)
...
class resconv_basic(nn.Module):
    ...
    def __init__(self, num_in_layers, num_out_layers, stride):
        ...
        self.conv3 = nn.Conv2d(num_in_layers,
                               num_out_layers,
                               kernel_size=1,
                               stride=stride)
        self.normalize = nn.BatchNorm2d(num_out_layers)
...
class Resnet50_md(nn.Module):
    ...
    def forward(self, x):
        ...
        self.udisp4 = nn.functional.interpolate(self.disp4,
                                                scale_factor=2,
                                                mode='bilinear',
                                                align_corners=True)
        ...
        self.udisp3 = nn.functional.interpolate(self.disp3,
                                                scale_factor=2,
                                                mode='bilinear',
                                                align_corners=True)
        ...
        self.udisp2 = nn.functional.interpolate(self.disp2,
                                                scale_factor=2,
                                                mode='bilinear',
                                                align_corners=True)
